...
local _2amodule_name_2a = "conjure-efroot.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("conjure-efroot.aniseed.core"), autoload("conjure-efroot.aniseed.compile"), autoload("conjure-efroot.aniseed.fennel"), autoload("conjure-efroot.aniseed.fs"), autoload("conjure-efroot.aniseed.nvim")
