package.preload["conjure-efroot.aniseed.fennel.repl"] = package.preload["conjure-efroot.aniseed.fennel.repl"] or function(...)
  local utils = require("conjure-efroot.aniseed.fennel.utils")
  local parser = require("conjure-efroot.aniseed.fennel.parser")
  local compiler = require("conjure-efroot.aniseed.fennel.compiler")
  local specials = require("conjure-efroot.aniseed.fennel.specials")
  local view = require("conjure-efroot.aniseed.fennel.view")
  ...
  commands.find = function(env, read, on_values, on_error, scope)
    local function _624_(_241)
      ...
      if ((_G.type(_625_) == "table") and (nil ~= (_625_).short_src) and ((_625_).what == "Lua") and (nil ~= (_625_).source) and (nil ~= (_625_).linedefined)) then
...
package.preload["conjure-efroot.aniseed.fennel.specials"] = package.preload["conjure-efroot.aniseed.fennel.specials"] or function(...)
  local utils = require("conjure-efroot.aniseed.fennel.utils")
  local view = require("conjure-efroot.aniseed.fennel.view")
  local parser = require("conjure-efroot.aniseed.fennel.parser")
  local compiler = require("conjure-efroot.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "conjure-efroot.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["conjure-efroot.aniseed.fennel.compiler"] = package.preload["conjure-efroot.aniseed.fennel.compiler"] or function(...)
  local utils = require("conjure-efroot.aniseed.fennel.utils")
  local parser = require("conjure-efroot.aniseed.fennel.parser")
  local friend = require("conjure-efroot.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["conjure-efroot.aniseed.fennel.friend"] = package.preload["conjure-efroot.aniseed.fennel.friend"] or function(...)
  local utils = require("conjure-efroot.aniseed.fennel.utils")
...
package.preload["conjure-efroot.aniseed.fennel.parser"] = package.preload["conjure-efroot.aniseed.fennel.parser"] or function(...)
  local utils = require("conjure-efroot.aniseed.fennel.utils")
  local friend = require("conjure-efroot.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["conjure-efroot.aniseed.fennel.view"] = package.preload["conjure-efroot.aniseed.fennel.view"] or function(...)
...
package.preload["conjure-efroot.aniseed.fennel.utils"] = package.preload["conjure-efroot.aniseed.fennel.utils"] or function(...)
  local view = require("conjure-efroot.aniseed.fennel.view")
  local version = "1.1.0"
...
utils = require("conjure-efroot.aniseed.fennel.utils")
local parser = require("conjure-efroot.aniseed.fennel.parser")
local compiler = require("conjure-efroot.aniseed.fennel.compiler")
local specials = require("conjure-efroot.aniseed.fennel.specials")
local repl = require("conjure-efroot.aniseed.fennel.repl")
local view = require("conjure-efroot.aniseed.fennel.view")
...
do
  ...
  local module_name = "conjure-efroot.aniseed.fennel.macros"
  local _
