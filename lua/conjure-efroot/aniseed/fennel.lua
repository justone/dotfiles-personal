...
local _2amodule_name_2a = "conjure-efroot.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("conjure-efroot.aniseed.core"), autoload("conjure-efroot.aniseed.fs"), autoload("conjure-efroot.aniseed.nvim"), autoload("conjure-efroot.aniseed.string")
...
local function impl()
  local compiler = require("conjure-efroot.aniseed.deps.fennel")
