...
local _2amodule_name_2a = "conjure-efroot.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("conjure-efroot.aniseed.core"), autoload("conjure-efroot.aniseed.fennel"), autoload("conjure-efroot.aniseed.fs"), autoload("conjure-efroot.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "conjure-efroot.aniseed.macros"
  local filename
  do
