...
local _2amodule_name_2a = "conjure-efroot.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("conjure-efroot.aniseed.compile"), autoload("conjure-efroot.aniseed.fennel"), autoload("conjure-efroot.aniseed.fs"), autoload("conjure-efroot.aniseed.nvim")
