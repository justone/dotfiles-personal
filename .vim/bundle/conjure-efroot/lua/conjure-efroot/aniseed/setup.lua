...
local _2amodule_name_2a = "conjure-efroot.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("conjure-efroot.aniseed.core"), autoload("conjure-efroot.aniseed.env"), autoload("conjure-efroot.aniseed.eval"), autoload("conjure-efroot.aniseed.nvim")
